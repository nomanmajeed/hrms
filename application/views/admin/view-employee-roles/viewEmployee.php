                    ...
                    <table id="datatable-fixed-header" class="table table-striped table-bordered">
                      ...
                      ?>
                        <tr>
                          ...
                          <td>
                            <a href="<?php echo base_url(); ?>admin/AdminDashboard/editEmployeeCrud/<?php echo $user->user_id; ?>">
                              <button class="btn btn-sm btn-primary"><i class="fa fa-edit"></i></button>
                            </a>
                            <a href="<?php echo base_url(); ?>admin/AdminDashboard/deleteEmployeeCrud/<?php echo $user->user_id; ?>">
